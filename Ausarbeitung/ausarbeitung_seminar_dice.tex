...
\input{chapters/Grundlagen}					% Grundlegende Begriffe und Terminologien
\input{chapters/Methodik} 					% Methodik vorstellen + Erklärung + Beispiel
\input{chapters/BewertungDerErklärungen} 	% Messbarkeit + Bewertung der Erklärungsqualität
\input{chapters/PraktischeAnwendung}		% Anwendbarkeit in der Praxis disktuieren
