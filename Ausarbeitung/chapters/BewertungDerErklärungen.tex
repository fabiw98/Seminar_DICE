...
\textbf{SingleCF} generiert ein einzelnes auf Proximität und Gültigkeit optimiertes Counterfactual \cite{Watcher.2019}. 
Die Methode \textbf{MixedIntegerCF} gegeneriert diverse Erklärungen durch Mixed Integer Programming \cite{Russell.2019}.
Eine Erweiterung der SingleCF ist die Methode \textbf{RandoimInitCF} zur Generierung von $k$ Counterfactuals mit zufälligen Startpunkten und einer nicht-konvexen Verlustfunktion. 
Die letzte Methode ist \textbf{NoDiversityCF}, wobei es die Verlustfunktion analog wie in DiCE zur gleichzeitigen Optimierung der Counterfactuals verwendet, wobei jedoch der $\lambda_2$-Parameter auf Null gesetzt wird, sodass der Diversitätsterm ignoriert wird.\cite{mothilal2020dice}
