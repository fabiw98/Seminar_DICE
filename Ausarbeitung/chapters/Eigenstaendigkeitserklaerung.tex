...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}
		...
		\hline
		Gemini & Anfertigung des Skripts für die Evaluationsmetriken und deren Berechnung für das demonstrierte Beispiel & Autoren haben keine eigene Evaluation bereitgestellt, daher wurde diese mit Hilfe von Gemini angefertigt, für eine bessere Diskussion der Ergebnisse. & Zur Berechnung der Werte in Tabelle \ref{tab:evaluation_comparison} & Als Eingabe wurden die Metriken und die CF-Mengen der Demonstration verwendet. & Tabelle \ref{tab:evaluation_comparison} \\
		\hline
