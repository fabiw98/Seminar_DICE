...
% CF / CF Klasse
Ein \textit{Counterfactual} (CF) ist hingegen ein leicht verändertes Eingabebeispiel, welches so gewählt wird, dass nicht die ursprünglich erhaltene, unerwünschte Klasse das Ergebnis ist, sondern eine andere Klasse. Diese erwünschte Klasse wird als \textbf{CF Klasse} bezeichnet. \cite{mothilal2020dice}
